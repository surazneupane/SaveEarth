            ...
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 text-center">
                    <p class="breadcrumbs"><span class="me-2"><a href="index.html">Home <i
                                    class="fa fa-chevron-right"></i></a></span> <span>Causes <i
                                class="fa fa-chevron-right"></i></span></p>
                    <h1 class="mb-0 bread">Causes Campaign</h1>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <div class="causes-wrap">
                        <a href="images/cause-1.jpg" class="img d-flex align-items-end justify-content-center glightbox"
                ...
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="1000">
                    <div class="causes-wrap">
                        <a href="images/cause-2.jpg" class="img d-flex align-items-end justify-content-center glightbox"
                ...
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300"
                    data-aos-duration="1000">
                    <div class="causes-wrap">
                        <a href="images/cause-3.jpg" class="img d-flex align-items-end justify-content-center glightbox"
                ...
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100"
                    data-aos-duration="1000">
                    <div class="causes-wrap">
                        <a href="images/cause-4.jpg" class="img d-flex align-items-end justify-content-center glightbox"
                ...
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200"
                    data-aos-duration="1000">
                    <div class="causes-wrap">
                        <a href="images/cause-5.jpg" class="img d-flex align-items-end justify-content-center glightbox"
                ...
                <div class="col-md-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300"
                    data-aos-duration="1000">
                    <div class="causes-wrap">
                        <a href="images/cause-6.jpg" class="img d-flex align-items-end justify-content-center glightbox"
